...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/uam-golang_internal_models.ErrorResponse"
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/uam-golang_internal_models.User"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "uam-golang_internal_models.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "uam-golang_internal_models.User": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
